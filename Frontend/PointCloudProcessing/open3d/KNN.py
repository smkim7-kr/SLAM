...
def nearest_neighbor_search(kdtree, query_point, k):
    """
    ...
    Returns:
        indices (list): Indices of the nearest neighbors.
    """
    # Perform search
    [_, idx, _] = kdtree.search_knn_vector_3d(query_point, k)
    return idx

def visualize_neighbors(pcd, query_point, neighbor_indices, point_size=1.0):
    """
    Visualize the point cloud and highlight the query point and its nearest neighbors.
    ...
    vis.create_window(window_name='Nearest Neighbor Search', width=800, height=600)
...
if __name__ == "__main__":
    ...
    neighbor_indices = nearest_neighbor_search(kdtree, query_point, k)

    # Visualize the query point and its nearest neighbors
